...
if __name__ == '__main__':    
    # 本地中文文本文件路径
    zn_filePath = 'C:/Users/Lenovo/Desktop/qq音乐一星评价.txt'

    # 本地中文字体路径
    zn_fontPath = 'yahei.ttc'

    # 本地图片(最好是白底)路径
    imagePath = 'C:/Users/Lenovo/Desktop/qq音乐logo.png'

    # 词云图保存路径
    imageSavePath = 'C:/Users/Lenovo/Desktop/qqstar1.png'

    # 中文停用词文本路径
    zn_StopWordPath = 'zn_STOPWORDS.txt'
    # 中文词云图生成器
